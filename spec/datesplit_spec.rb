...
describe Datesplit do
  it "handles a format of '<Month> <Day> to <Month> <Day>, <Year>'" do
    ...
    d.start_date.should == Date.parse('April 11, 2012')
    d.end_date.should == Date.parse('April 20, 2012')
  end

  it "handles a format of '<Month> <Day> to <Month> <Day>'" do
    d = Datesplit.new('April 11 to April 20')
    d.start_date.should == Date.parse('April 11')
    d.end_date.should == Date.parse('April 20')
  end
  ...
  it "handles a format of '<Month> <Day>-<Month> <Day>, <Year>'" do
    ...
    d.start_date.should == Date.parse('March 30 2012')
    d.end_date.should == Date.parse('April 1 2012')
  end

  it "handles a format of '<Month> <Day>, <Year> to <Month> <Day> <Year>'" do
    d = Datesplit.new('April 9, 2012 to January 1st 2013')
    d.start_date.should == Date.parse('April 9 2012')
    d.end_date.should == Date.parse('January 1 2013')
  end
